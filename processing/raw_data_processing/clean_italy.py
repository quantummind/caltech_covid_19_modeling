...
pd.concat(sets_reg).to_csv(datadir + 'dati-regioni-en/dpc-covid19-ita-regioni-total.csv', index=False)
...
pd.concat(sets_prov).to_csv(datadir + 'dati-province-en/dpc-covid19-ita-province-total.csv', index=False)
