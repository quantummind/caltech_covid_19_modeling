...
def make_erf_predictions(df, county_fips, key='deaths', last_date_pred='2020-06-30', start_date='2020-04-01',
                         boundary_date=None):
    '''
...
if __name__ == '__main__':
    ...
    predict_all_counties(df, boundary_date='2020-04-07', out_file='erf_model_case_predictions_dvar_0407_cumulative.csv',
                         key='cases')
